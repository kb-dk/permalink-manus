...
public class Manus 
{
    ...
    private Logger     LOGGER        = LoggerFactory.getLogger(Manus.class);
	...
	LOGGER.debug("setting up the dom tree");
	...
	LOGGER.debug("adding root to a doc");
	...
	*/
	...
	LOGGER.debug("our mods thing is added to the dom tree");
