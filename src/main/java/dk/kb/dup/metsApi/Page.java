...
public class Page 
{
   ...
   */
    ...
    */
    ...
    while(datarator.hasNext()) {
       ...
       */
      String id       = "file:default:"+this.manusId+":"+row.get("PAGEID");
      ...
      String pageInfoAltLang = "";
      if(row.get("PAGEINFO_ALTLANG") != null) {
      ...
      if(row.get("PAGEINFO") != null) {
        ...
        String dmdId = "dmd:"+this.manusId+":"+row.get("PAGEID");
    ...
    */
    ...
    while(datarator.hasNext()) {
      ...
      */
      DOMElement file = new DOMElement("file",metsNS);
      DatabaseRow row = (DatabaseRow)datarator.next();
      String id =  "file:variant:"+this.manusId+":"+row.get("PAGEVARID");
      file.addAttribute("ID",id);
      DOMElement div  = new DOMElement("div",metsNS);
      String divid    = this.getDataSourceLabel() + ":" +
  ...
  private void getData() {
    ...
    SQL = "select * from manus.pagevar where manusid=" + this.manusId +
